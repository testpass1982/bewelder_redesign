"""
Django settings for bewelder_redesign project.
...
SECRET_KEY = 'vd0l%=zj66k$^ob5zdwwvxmfiiop198scrjbh*16*2^y(h=xra'
...
ROOT_URLCONF = 'bewelder_redesign.urls'
...
WSGI_APPLICATION = 'bewelder_redesign.wsgi.application'
